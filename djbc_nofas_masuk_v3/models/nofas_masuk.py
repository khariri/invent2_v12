...
class DJBCNofasMasukV3(models.Model):
    _name = 'djbc.nofas_masuk_v3'
    ...
    def init(self):
        self.env.cr.execute("""
        DROP FUNCTION IF EXISTS djbc_nofas_masuk_v3(DATE, DATE);
        CREATE OR REPLACE FUNCTION djbc_nofas_masuk_v3(date_start DATE, date_end DATE)
...
BEGIN
	delete from djbc_nofas_masuk_v3;
	-- v_wh='WH/Stock';
	
	for rec in csr loop
		insert into djbc_nofas_masuk_v3 (no_dok, tgl_dok,jenis_dok,no_penerimaan, tgl_penerimaan, pengirim, kode_barang,
