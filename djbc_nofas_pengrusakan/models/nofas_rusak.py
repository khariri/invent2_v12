...
class DJBCNofasRusak(models.Model):
    _name = 'djbc.nofas_rusak'
    _description = 'DJBC Laporan Pengrusak'
    _rec_name = 'no_dok'
...
BEGIN
	...
	for rec in csr loop
		insert into djbc_nofas_rusak (no_dok, tgl_dok,jenis_dok,no_pengeluaran, tgl_pengeluaran, penerima, kode_barang,
